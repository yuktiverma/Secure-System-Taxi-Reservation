...
<div align="left">
        ...
        <td width="44%">
          ...
          <table width="98%" height="345" >
            ...
            <tr>
              ...
              <th width="47%" height="238" scope="col"><table width="100%" >
                <tbody>
                  <tr>
                    <th height="347" scope="col"><div id="wrapper">
                        <%
    System.out.print("session before"+request.getSession(false));
  if(request.getSession(false)!=null)
  {
      session.invalidate();
  }
   System.out.print("session after"+request.getSession(false));
  ...
  %>
                      ...
                      <form action="BookingServlet" method="post">
                        <fieldset>
                          <legend>Book A Taxi</legend>
                          <div>
                            <input type="text" name="source" placeholder="Pick Up Location"/>
                            </div>
                          <div>
                            <input type="text" name="destination" placeholder="Drop Off Location"/>
                            </div>
                            <div>
                            <input type="text" name="pickUpTime" class="timepicker" placeholder="Pick Up Time"/>
                            </div>
                            <div>
                            <input type="text" name="pickUpDate" placeholder="pickUpDate"/>
                            </div>
                          
                          
                          <input type="submit" name="submit" value="Book a Taxi"/>
                          </fieldset>    
                        </form>
                      </div></th>
                    </tr>
